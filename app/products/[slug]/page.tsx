      ...
      <Section>
        <Container className='pt-9'>
          <article className='flex h-full w-full flex-col overflow-hidden rounded-3xl bg-[#E3E7DC]  text-background md:h-[80vh] md:rounded-[3rem] lg:flex-row '>
            <picture className='relative h-full  max-h-80  w-full overflow-hidden max-[766px]:aspect-w-1 max-[766px]:aspect-h-1 max-[490px]:aspect-1 md:max-h-full md:rounded-[3rem] '>
              <Image
            ...
            <article className='relative flex h-full w-full flex-col justify-center rounded-3xl bg-primary px-8 py-10 md:rounded-[3rem] md:px-20 md:py-16'>
              ...
              <p className='mt-4 text-base leading-normal opacity-90 md:max-w-[50ch] md:text-lg'>{tea.description}</p>
