          ...
          <Container>
            <SlideUp>
              <article className='flex flex-col items-center justify-center  px-6 leading-normal'>
                <Balancer ratio={0.9}>
                  <h2 className='text-xl md:max-w-[73ch] md:text-center md:text-2xl'>{`Japanese green teas are a healthy dose of rich flavour, elegant aroma and pure umami. It's delight in every sip. It's that needed energy boost in the morning. It's a refreshing sensation of light rain during a hot summer day. It's unlocked creativity, and hours of laser focus. It's what your mind wants, and your body needs. It's nothing but good vibes, delivered straight to your door.`}</h2>
                </Balancer>
