          ...
          <SlideUp>
            <div>
              ...
              <p className="mt-3 max-w-[40ch] text-lg  opacity-90">
                Get delicious recipes, discounts and monthly updates delivered
              ...
              >
                <input
                  type="hidden"
                  name="u"
                  value="3ad2e80b5f97babeaef25ccfa"
                />
                <input type="hidden" name="id" value="00a97f1a2e" />
                <>
                  <div
                    id="mergeRow-0"
                    className="input-wrapper w-full md:col-span-2"
                  >
                    <>
                      <input
                        type="email"
                      ...
                      <div className="icon absolute top-[1.1rem] left-[1rem] mb-1">
                        <Mail
                          size={20}
                          className={"stroke-primary/80  stroke-2"}
                        />
                      </div>
                    </>
                  </div>
                  ...
                  <input
                    type="hidden"
                    name="ht"
                    value="69825c556c7e7dfb59219f465435ea56eb03b3b1:MTY3MTQ1NjA1MC4wMjg0"
                  />
