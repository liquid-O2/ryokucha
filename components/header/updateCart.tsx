...
const UpdateCart = ({ quantity, slug, dispatch }: { quantity: number; slug: string; dispatch: any }) => {
  ...
  return (
    <menu className='flex w-full flex-wrap   gap-3  '>
      <menu className='flex max-w-full items-center justify-between rounded-full  border border-primary/10  bg-tertiary-light bg-opacity-[0.01] px-0 py-0 text-primary md:w-fit'>
        <button
