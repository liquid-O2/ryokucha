  ...
  return (
    <Container>
      <section className=' border-t border-primary/10  grid grid-cols-2 md:grid-cols-4 gap-2 pt-8 '>
        <section className='col-span-2 h-full pb-7 md:pb-12'>
          <div className='flex md:flex-col items-center md:items-start justify-between'>
            <div className='text flex flex-col justify-end '>
              <p className='font-semibold tracking-tighter leading-none text-2xl md:text-3xl mt-1'>ryo.</p>
            </div>
            <button
              onClick={() => window.scrollTo(0, 0)}
              className='flex w-10 justify-center rounded-full items-center p-2 md:mt-9 shadow-lg shadow-primary/40 bg-primary text-background'>
              <span className='sr-only'>scroll to the top of the page</span>
              <ChevronUp />
            </button>
          </div>
        </section>
        <section className='flex md:items-end flex-col gap-3 text-base md:text-xl leading-none mb-12 '>
        ...
        <section className='flex items-end flex-col gap-3 text-base md:text-xl leading-none'>
        ...
        <section className='border-t  text-sm border-primary/10 col-span-2 md:col-span-4 flex justify-between py-4'>
